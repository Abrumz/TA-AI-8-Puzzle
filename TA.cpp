...
void A_star(node *root, int max_iterations)
{
...
int main()
{
     ...
     printf("\nThe seq of steps are %d\n", f_count);

     A_star(n, 2000);
     pop_queue_and_free(); // Ensure that the final dequeued node is freed
     scanf("%d", &i);
     return 0;
}
